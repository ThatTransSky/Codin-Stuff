...
module.exports = {
  ...
  async execute(interaction, client) {
    ...
    if (command.perms && !interaction.member.permissions.has(command.perms)) {
      // Rarely Used since Discord blocks /commands for users who don't have the required permissions.
      ...
      // Checks that the bot has enough permissions to execute the command.
      return interaction.reply({
